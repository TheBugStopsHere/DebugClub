  ...
  return (
    <div id="aboutUsContainer">
      <div id="aboutUs">
        ...
        <h4 className="aboutUsContent">
          We hope you enjoy our site and its many puns! We are new developers in
          our final phase of a software engineering program with{' '}
          <a id="fsLink" href="https://www.fullstackacademy.com/">
            Fullstack Academy
          </a>. While some technologies are still new to us, we are pleased to
          present this "full-stack" accomplishment. We had 8 days to plan and
        ...
        <h4 className="aboutUsContent">
          <ul>
            <li>
              A user can sign up and will be able to log in each time they
              return.
            </li>
            ...
            <li>
              A user's personal information, other than email, is not required
